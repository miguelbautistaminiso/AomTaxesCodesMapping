...
import mx.com.miniso.jpa.repositories.MexTaxCodeRepository;
...
@Component(value = "hanaDbMex")
public class HanaDbMex implements  InitializingBean, DisposableBean {

    protected Logger log = Logger.getLogger(HanaDbMex.class.getName());
...

        {
            try {
                ...
                while (resultSet.next()){
                    MexTaxCodeEntity mexTaxCodeEntity = new MexTaxCodeEntity();
                    mexTaxCodeEntity.setUpc(resultSet.getString(1));
                    mexTaxCodeEntity.setSku(resultSet.getString(2));
                    mexTaxCodeEntity.setCode(resultSet.getString(3));

                    mexTaxCodeRepository.save(mexTaxCodeEntity);
                }
